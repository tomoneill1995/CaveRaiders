modifier_axe_throw = class({})

-------------------------------------------------------------------

function modifier_axe_throw:IsHidden()
	return true
end

-------------------------------------------------------------------

function modifier_axe_throw:IsPurgable()
	return false
end

-------------------------------------------------------------------

function modifier_axe_throw:RemoveOnDeath()
	return false
end

-------------------------------------------------------------------

function modifier_axe_throw:OnCreated( kv )
	if IsServer() then
...
function modifier_axe_throw:OnIntervalThink()
	if IsServer() then
...
function modifier_axe_throw:OnDestroy()
	if IsServer() then
...
function modifier_axe_throw:HasHitTarget( enemy )
	if IsServer() then
...
function modifier_axe_throw:AddHitTarget( enemy )
	if IsServer() then
